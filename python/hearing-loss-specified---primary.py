...
codes = [{"code":"7319y00","system":"readv2"},{"code":"F582.00","system":"readv2"},{"code":"F590000","system":"readv2"},{"code":"F591000","system":"readv2"},{"code":"F59y.00","system":"readv2"},{"code":"FyuU100","system":"readv2"},{"code":"P400.00","system":"readv2"},{"code":"P40z.00","system":"readv2"}];
REQUIRED_CODES = 1;
